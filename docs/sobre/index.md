...
A plataforma não tem fins lucrativos, tratando meramente de trabalho voluntário. Não pertencemos a nenhum grupo político que governa ou já governou a cidade de Tucano. Não somos filiados a nenhum partido político. Praticamos política e cidadania através da divulgação e análise de dados abertos. 


## Equipe de voluntários 


[**Carlos André**](https://www.instagram/dhematos): 💻 Desenvolvimento e 📈 Ciência de Dados.


Gostaria de participar do [**Dados Abertos Tucano**](https://dadosabertostucano.org) como voluntário(a)? Venha fazer parte do grupo: [**Saiba mais**](/sobre/participe). 
...
??? "➡️ Ferramentas de acessibilidade"
    ...
    <center>
       <audio controls>
          ...
          Seu browser não suporte elemento de áudio.
       </audio>
    </center>
...
## :world_map: Exemplo de icon mapa
