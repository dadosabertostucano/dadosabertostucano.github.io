...
!!! success "Comentário"
    Utilize suas habilidades para disponibilizar e divulgar dados abertos de Tucano, Bahia. 

Como você pode contribuir: 

+ Habilidade de programação em Python e bibliotecas de análise de dados;

+ Habilidade de Pesquisa Operacional; 

+ Habilidade de Design; 

+ Habilidade de Comunicação Social; 

+ Habilidade de Revisão Textual; 

+ Habilidade de apresentação de informações em vídeos para redes sociais; 

+ Formação Direito, Serviço Social, Psicologia, Contabilidade, Saúde, economia, geografia, Matemática, Estatística, Computação e Pedagogia; 

Se você encaixa-se em pelo menos um destes itens acima e tem um tempinho sobrando, seja uma/um voluntária/voluntário no Projeto [**Dados Abertos Tucano**](https://dadosabertostucano.org). Vamos levar cidadania através de dados abertos! 

Você ainda pode fazer parte mesmo não tendo nenhuma habilidade ou formação informada acima, temos um treinamento para voluntariado em pesquisa, análise de dados e design gráfico totalmente gratuito e a distância. [**Saiba mais**](https://api.whatsapp.com/send?1=pt_BR&phone=5575991940520). 
