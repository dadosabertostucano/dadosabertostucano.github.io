...
O usuário(a), ao acessar a plaforma no endereço: [dadosabertostucano.org](https://dadosabertostucano.org) não tem recolhimento de informações via cache. Utiliza-se somente o restreamento via _GOOGLE ANALYTICS_.
