...
# Dados Abertos COVID-19 em Tucano 


## Introdução 

Disponibilizar e publicar dados abertos que tenham relação direta com a COVID-19 em Tucano/BA. 

## Dados 

Os dados serão disponibilizados no [App](app.dadosabertostucano.org) para consulta. 
Em breve vamos disponibilizar aqui dados atualizados para baixar. 

## Fonte de dados 

1. [Painel de combate ao COVID-19 - Prefeitura de Tucano](http://www.tucano.ba.gov.br/painel-tucano-combate-a-covid-19/)

2. [Painel Estadual de COVID-19](https://bi.saude.ba.gov.br/transparencia/)

3. [Painel COVID - Min. Saúde](https://covid.saude.gov.br/)
